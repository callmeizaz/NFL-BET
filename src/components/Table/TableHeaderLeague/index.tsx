...
const TableHeaderLeague = (props: IProps) => {
  const classes = useStyles();
  const { headerGroups, dense } = props;
  return (
    <div
      className={clsx("table-header-group sticky top-0 py-4 w-full", classes.header)}
    >
      {
        ...
        headerGroups.map((headerGroup) => {
          ...
          return (
            <div {...headerGroup.getHeaderGroupProps()} className="table-row w-full">
              {
                  ...
                  return (
                    ...
                    >
                      <Typography
                        ...
                        variant={dense ? "caption" : "subtitle1"}
                      >
                        {
                          // Render the header
...
export default TableHeaderLeague;
