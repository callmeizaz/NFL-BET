...
const LeagueContestDetailsDesktop = ({
  myTeamId,
  opponentTeamId,
  myTeam,
  opponentTeam,
    ...
    () => [
      {
        ...
        Cell: ({ row }: any) => {
          ...
          return CellText(player?.position, isGray);
        },
      },
      {
        Header: "Player",
    ...
    <Hidden only={["xs", "sm"]}>
      <Fragment>
        <div className="mb-4 flex items-stretch relative">
          <Typography className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-gray-400">
            VS
          </Typography>
        ...
        <div className="flex -mx-6 lg:-mx-8">
          <div
            className="w-1/2 relative pb-12 table"
            style={{ border: "1px solid #e8e8e8" }}
          >
            <TableHeaderLeague headerGroups={myHeaderGroups} />
            <TableBodyLeague
              getTableBodyProps={myTableBodyProps}
              rows={myRows}
              prepareRow={prepareMyRow}
          ...
          <div
            ...
            style={{ border: "1px solid #e8e8e8" }}
          >
            <TableHeaderLeague headerGroups={opponentHeaderGroups} />
            <TableBodyLeague
              getTableBodyProps={opponentTableBodyProps}
              rows={opponentRows}
              prepareRow={prepareOpponentRow}
...
export default LeagueContestDetailsDesktop;
